...
#	),
	...
	[
		...
		(agent_fade_out, ":player_agent"),
        (troop_clear_inventory, "trp_player"),
        (troop_add_item, "trp_player","itm_succubus_scythe"),
		(troop_add_item, "trp_player","itm_succubus_head"),
		(troop_add_item, "trp_player","itm_succubus_gloves"),
		(troop_add_item, "trp_player","itm_succubus_upper_out"),
		(troop_add_item, "trp_player","itm_succubus_shoes"),
        (troop_equip_items, "trp_player"),
		(set_visitor, 0, "trp_player"),
	],
	),
	...
	[
        ...
        (troop_add_item, "trp_player","itm_succubus_scythe"),
		(troop_add_item, "trp_player","itm_succubus_head"),
		(troop_add_item, "trp_player","itm_succubus_hands"),
		(troop_add_item, "trp_player","itm_succubus_upper_in"),
		(troop_add_item, "trp_player","itm_succubus_shoes"),
        (troop_equip_items, "trp_player"),
		(set_visitor, 0, "trp_player"),
	],
	...
	[
		...
		(agent_fade_out, ":player_agent"),
        (troop_clear_inventory, "trp_player"),
        (troop_add_item, "trp_player","itm_succubus_scythe_no_wheel"),
		(troop_add_item, "trp_player","itm_succubus_head"),
		(troop_add_item, "trp_player","itm_succubus_hands"),
		(troop_add_item, "trp_player","itm_succubus_upper_broken"),
		(troop_add_item, "trp_player","itm_succubus_shoes_broken"),
        (troop_equip_items, "trp_player"),
		(set_visitor, 0, "trp_player"),
	],
	),
	##test equipment wear end
