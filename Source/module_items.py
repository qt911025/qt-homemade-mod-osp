...
["test_rifle", "Automatic Siege Crossbow", [("crossbow_c",0)], itp_type_musket |itp_primary|itp_two_handed ,itc_rifle,
 ...
 [(ti_on_init_item, [(item_set_slot,"itm_test_rifle",slot_item_shot_sound,"snd_release_crossbow"),
                     (item_set_slot,"itm_test_rifle",slot_item_is_automatic,1),
 ]),
  (ti_on_weapon_attack,[
                        ...
                        (particle_system_burst, "psys_gun_fire", pos1, 20),

 ]),]],

["test_magic_swords","Magic Swords", [("sword_medieval_b_small",0),("sword_medieval_b_small_scabbard", ixmesh_carry)], itp_type_thrown |itp_primary|itp_no_pick_up_from_ground ,itcf_throw_javelin|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
...
[(ti_on_missile_hit,[
  ...
  (try_for_range,":unused",0,10),
    (call_script,"script_add_script_after_seconds",5,"script_cf_spawn_missile_at_point",":attacker_agent","itm_test_magic_swords_sub","itm_test_magic_swords_sub",":pos_x",":pos_y",":pos_z"),
    (val_add,":pos_y",50),
  (try_end),
])]],
["test_magic_swords_sub","Swords", [("sword_medieval_b_small",0),("sword_medieval_b_small_scabbard", ixmesh_carry)], itp_type_thrown |itp_primary|itp_no_pick_up_from_ground ,itcf_throw_javelin|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
155 , weight(1.5)|difficulty(0)|spd_rtng(95) | shoot_speed(28) | thrust_damage(30 ,  pierce)|max_ammo(7)|weapon_length(85),imodbits_sword_high ],
