...
["test_rifle", "Automatic Siege Crossbow", [("crossbow_c",0)], itp_type_musket |itp_primary|itp_two_handed ,itc_rifle, 
 ...
 [(ti_on_init_item, [(item_set_slot,"itm_test_rifle",slot_item_shot_sound,"snd_release_crossbow"),
                     ...
                     (item_set_slot,"itm_test_rifle",slot_item_accuracy,75),
 ]),
  (ti_on_weapon_attack,[
                        (store_trigger_param_1,":attacker_agent"),
                        (agent_get_wielded_item,":agent_cur_weapon",":attacker_agent"),
                        (item_get_slot,":item_length",":agent_cur_weapon",slot_item_length),
...
[(ti_on_missile_hit,[
  ...
  (try_for_range,":unused",0,10),
    (call_script,"script_add_script_after_seconds",5,"script_spawn_missile_at_point",":attacker_agent","itm_test_magic_swords_sub","itm_test_magic_swords_sub",":pos_x",":pos_y",":pos_z"),
    (val_add,":pos_y",50),
  (try_end),
])]],
