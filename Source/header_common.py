...
multiplayer_game_type_conquest             = 0
multiplayer_num_game_types                   = 1
...
multi_troop_class_engineer = 2
multi_troop_class_cavalry = 3
multi_troop_class_sailor = 4
multi_troop_class_civilian = 5
multi_troop_class_driver = 6
multi_troop_class_supporter = 7
