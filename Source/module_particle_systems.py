...
##### Dungeon Water Drops  END #####
    ...
    ("rifle_smoke", psf_billboard_3d, "prtcl_dust_a",
        100, 0.5, 30, -0.2, 45.0, 1.5,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
        (0.0, 0.75), (1, 0),       #alpha keys
        (0.0, 0.7), (1, 0.4),      #red keys
        (0.0, 0.7),(1, 0.4),       #green keys
        (0.0, 0.7), (1, 0.4),      #blue keys
       ...
       ("gun_fire", psf_billboard_3d, "prt_mesh_fire_1",
        500, 0.05, 30, 0, 10, 1,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
